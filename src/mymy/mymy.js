            ...
            if(e.deltaY>0){//마우스 휠
                ...
                if(window.pageYOffset < view){
                    ...
                    if(PageTwoText==1){
                        ...
                        setPageTwoText(2)
                    }else if(PageTwoText==2){
                        MyNameIS[0].style.transform=`scale(20) translate(-50px, 275px)`
                        setPageTwoText(3)
                    }else if(PageTwoText==3){
                        MyNameIS[0].style.transform=`scale(15) translate(-50px, 250px)`
                        setPageTwoText(4)
                    }else if(PageTwoText==4){
                        MyNameIS[0].style.transform=`scale(10) translate(-50px, 200px)`
                        setPageTwoText(5)
...
{/* <svg width="500" height="500">
        ...
        className="star" />
            ...
            <svg className="MyNameIS" style={{ transform:`scale(45) translate(-50px, 275px)`   
}} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100%" viewBox="0 0 600 300" >
                    <path className="g" fill="#ffffff" opacity="1.000000" stroke="none" 
                        d="
