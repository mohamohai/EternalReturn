...
function Character_Detail() {
    ...
    const AllSkinEng = [
      ...
      ["Default", "MidnightBreeze"],
      ["Default", "Hitman", "WinterCarnival"],
      ["Default", "Maid", "Witch"],
      ["Default", "Capo", "Mistletoe"],
      ["Default", "BlackRose", "EliteExecutioner"],
      ["Default", "Bartender", "StreetFiend"],
      ["Default", "CombatMedic"],
      ["Default", "WhiteQueen"],
      ["Default", "Wasteland","DemonHunter"],
    ...
    const SkillName = [
      ...
      ["재생","빨리감기","일시정지","되감기","녹화","Martina"],
      ["웨폰케이스","40mm유탄","산탄 포화","기관단총","로켓 런처","Haze"],
      ["착취","현장 급습","경화","추격 / 검거"," 강탈", "Isaac"],
      ["아르띠지아나토","스틸레토","피아스코","프리치아","파라디소"],
      ["고양이의 습성","바운싱 볼","친구할래요","사뿐","고양이로 펑!","Irem"],
      ["","","","",""],
      ["","","","",""],
      ["","","","",""],
      ["","","","",""],
    ...
    const SkillExplancation = [
      ...
      ["마르티나의 4K UHD 카메라는 기본 공격을 할 때마다 전력을 소모하며 충전이 완료될 때까지 기본 공격을 할 수 없습니다. 충전 시간은 <color=white>녹화</color> 스킬 레벨이 높아질수록 감소합니다.\n\n종군 기자인 마르티나는 직감적으로 교전이 일어나는 지역을 파악할 수 있습니다. 일정 범위 내에서 적 실험체 간 교전이 발생한 지점에 특수핑이 표시됩니다.\n\n마르티나의 기본 공격은 대상자의 시야를 제공 받으며 야생 동물에게는 최대 체력 일정 수치만큼 추가 피해를 입힙니다. 추가로 공격 속도가 일정 수치만큼 증가할 때 마다 공격력이 증가합니다.\n\n<color=#808080>감시 카메라</color>와 <color=#808080>나뭇가지</color>를 조합하여 잠입 효과를 가진 <color=#008000>위장 카메라</color>를 제작할 수 있습니다.\n\n<color=#ffffff>[취재 중]</color>\n마르티나가 적에게 기본 공격을 연속해서 피해를 입히면 표식을 부여합니다. 표식이 부여된 적에게 스킬 적중 시 표식이 소모되며 스킬 피해를 입힙니다.\n\n<color=#ffd775>[방송 중]</color>\n기본 공격과 표식 소모 시 피해량이 증가합니다.", "<color=#ffffff>[취재 중]</color>\n마르티나가 지정한 방향을 촬영하여 스킬 피해를 입힙니다. 스킬 적중 시 쿨다운이 감소하고, 표식을 소모시키면 마르티나의 이동 속도가 증가합니다.\n\n<color=#ffd775>[방송 중]</color>\n스킬 사거리와 피해량이 증가하며 표식을 소모시키면 이동 속도와 공격 속도가 증가합니다.", "<color=#ffffff>[취재 중]</color>\n마르티나가 일정 시간 동안 유지되는 소형 카메라를 설치하여 주변 시야를 확보합니다. <color=white>빨리감기</color> 스킬로 소형 카메라를 적중 시 소형 카메라가 마르티나가 있는 방향을 촬영하여 적에게 스킬 피해를 입히고 이동 속도를 느려지게 합니다.\n\n<color=#ffd775>[방송 중]</color>\n소형 카메라 촬영이 적을 속박 시키며 최대 보유 및 설치 가능 수가 증가합니다.", "<color=#ffffff>[취재 중]</color>\n마르티나가 현재 위치에 비디오테이프를 남기고 지정한 방향으로 도약합니다. 이후 스킬 지속 시간 동안 되감기 상태를 유지합니다. 되감기 상태 동안 마르티나의 이동 속도가 소폭 증가합니다.\n\n되감기 상태가 종료되면 모든 방해 면역 상태로 비디오테이프로 빠르게 돌아오며 마르티나에 닿은 적은 이동 속도가 감소합니다.\n\n재사용 시: 비디오테이프로 더 일찍 돌아옵니다.\n\n<color=#ffd775>[방송 중]</color>\n비디오테이프로 돌아올 때 마르티나에 닿은 적이 기절하게 되며 되감기 상태 동안 실험체로부터 받은 피해량의 일부만큼 체력을 회복합니다.", "<color=#ffffff>[취재 중]</color>\n마르티나가 일정 시간 동안 지정한 방향을 촬영합니다. 촬영하는 동안 범위 내 촬영 대상이 들어올 경우 녹화 지속시간 동안 이동 속도가 증가합니다. 촬영에 성공하면 대상에 따라 <color=white>녹화 중첩</color>을 획득하고 이동 속도가 증가합니다.\n촬영에 실패하면 쿨다운이 감소합니다.\n\n<color=white>녹화 중첩</color>을 일정 수준 이상 쌓으면 마르티나가 취재를 마치고 <color=#ffd775>방송</color>을 시작하며 스킬 위력이 강화됩니다.\n\n<color=#2ECCFA>촬영 조건</color>: <color=#819FF7>촬영 대상</color> 중 2개의 대상을 일정 시간 이상 촬영 시 녹화 중첩 2와 무기 숙련도 획득.\n<color=#2ECCFA>시체 촬영 조건</color>: <color=#819FF7>촬영 대상</color> 중 1개의 시체를 일정 시간 이상 촬영 시 녹화 중첩 1과 무기 숙련도 획득. (최대 중첩 획득 제한, 동일한 시체 중복 촬영 불가)\n<color=#819FF7>촬영 대상</color>: 적 실험체, 생명의 나무, 운석, 알파, 오메가, 위클라인, 감마\n\n<color=#ffd775>[방송 중]</color>\n마르티나가 지정한 방향을 촬영하여 적에게 피해를 입힙니다. 스킬이 종료될 때 더 큰 피해를 입히며 가운데에 있는 적들을 기절시킵니다. 기절 시간은 스킬 지속 시간 동안 대상이 피해를 받은 횟수에 비례해 증가합니다.", "Martina"],
      ["<color=white>죽음의 상인</color>: 헤이즈는 장전을 하는 대신 웨폰 케이스에서 탄창이 꽉찬 새 돌격 소총을 꺼냅니다. 꺼내는 동안 기본 공격을 할 수 없지만, 이후 첫 기본 공격은 공격 속도가 증가하고 추가 스킬 피해를 입히며, 실험체에게 적중하면 이동 속도가 증가합니다. <color=white>죽음의 상인</color> 효과는 돌격 소총 폼에서만 적용됩니다.\n\n<color=white>웨폰 케이스</color>: 헤이즈는 각 스킬 마다 다른 종류의 총기를 활용하며, 사용이 끝나면 웨폰 케이스에서 새로운 돌격 소총을 꺼내고 <color=white>죽음의 상인</color> 효과를 시작합니다.\n\n헤이즈는 수동 장전과 비전투 자동 장전을 할 수 없으며, 무기를 교체해도 탄환 수를 유지합니다.","<color=white>돌격 소총 폼</color>: 유탄 발사기를 격발하여 적중한 적에게 스킬 피해를 입히고, 느려지게 합니다. 중심에 맞은 적은 더 큰 피해를 입고, 더 크게 느려집니다. 유탄 탄환은 최대 2개까지 충전됩니다.\n\n<color=white>기관단총 폼</color>: 짧은 시간 정신을 집중하여 전방에 기관단총을 연사하여 스킬 피해를 입히고, 기관단총 폼을 종료합니다. 남아 있던 탄환 수만큼 피해가 더해집니다.\n\n<color=white>로켓 런처 폼</color>: 적을 관통하는 가속 로켓을 발사합니다. 적중한 적에게 스킬 피해를 입히고 느려지게 하며, 절반 만큼의 피해는 대상의 후방으로 퍼집니다. 로켓은 시간이 지나면 가속되며, 범위가 넓어지고 피해가 증가합니다. 이 스킬은 기본 공격과 쿨다운을 공유하며, 쿨다운 감소 스탯의 영향을 받지 않습니다.","뒤로 한 걸음 물러서서 전방에 산탄총을 발사하여 적중한 적에게 스킬 피해를 입히고, 짧은 시간 기절시킵니다.\n\n<color=white>기관단총 폼</color> 혹은 <color=white>로켓 런처 폼</color>에서 사용한 경우, 폼을 해제하며 해당 스킬의 쿨다운을 추가로 감소시킵니다.","<color=white>기관단총 폼으로 전환</color>: 전방으로 짧게 돌진하고, 지속 시간 동안 40발 탄창의 기관단총 폼으로 전환합니다.\n\n기관단총 폼에서는 이동하면서 대상을 공격할 수 있으며, 공격 명령으로 대상을 변경할 수 있습니다. 각 공격은 짧은 간격으로 스킬 피해를 입히고, 5번째 탄환 마다 기본 공격 적중 시 효과가 적용됩니다. 폼을 유지하는 동안 제작, 채집 등 일부 행동이 제한되며, <color=white>40mm 유탄</color> 스킬이 <color=white>기관단총 연사</color> 스킬로 변경됩니다.\n\n기관단총 폼이 종료되면 남은 탄환 수에 비례해 쿨다운이 감소됩니다.","<color=white>로켓 런처 폼으로 전환</color>: 웨폰 케이스를 휘둘러 적을 밀쳐내며 스킬 피해를 입히고, 지속 시간 동안 4발 탄창의 로켓 런처 폼으로 전환합니다.\n\n로켓 런처 폼에서는 사거리와 공격 속도가 고정되고, 이동 속도가 감소합니다. 또한 기본 공격에 치명타가 적용되지 않으며, 피격된 대상 후방으로 퍼지는 스킬 피해를 추가로 입힙니다. 폼을 유지하는 동안 <color=white>40mm 유탄</color> 스킬이 <color=white>엑셀러레이션 로켓</color> 스킬로 변경됩니다.\n\n로켓 런처 폼이 종료되면 남은 탄환 수에 비례해 쿨다운이 감소됩니다.","Haze"],
      ["같은 적에게 4번째 공격을 할때마다 추가 스킬 피해를 입히고, 이동 속도가 증가합니다. 입힌 착취 피해량의 일정량을 아이작의 체력으로 회복 시킵니다.","아이작이 적에게 돌진 후, 강하게 타격하여 스킬 피해를 입힙니다.","아이작이 무기의 경도를 높여 다음 기본 공격이나 기본 스킬을 강화해 스킬 피해를 추가로 입히고, 대상의 보호막을 파괴합니다. 이 스킬로 강화된 기본 공격 또는 기본 스킬이 착취를 발동 시키면 기본 스킬의 쿨다운이 감소합니다.","아이작이 재빠르게 돌진하고, 다음 스킬을 준비합니다.\n\n재사용 시: 전방의 적들을 끌어당겨 스킬 피해를 입히고, 잠시 동안 기절 시킵니다.","아이작이 지정한 지점을 강하게 내려치며 스킬 피해를 입히고, 착취 표식이 없는 적들을 범위 밖으로 밀어버립니다. 이 스킬로 착취를 발동 시키면 대상의 잃은 체력에 비례하는 추가 스킬 피해를 입히고, 잠시 동안 이동속도를 크게 감소 시킵니다.","Issac"],
      ["<color=#white>아르띠지아나토</color>: 타지아는 <color=#white>유리 파편</color>을 파괴할 때 마다 {1}초 동안 지속되는 <color=#white>조각모음</color>을 1스택을 얻습니다. <color=#white>조각모음</color>이 4스택이 되면 <color=#white>유리 검</color>을 생성합니다.\n\n<color=#white>디페토소</color>: 타지아는 일정 시간마다 기본 공격으로 <color=#white>{0}</color>의 추가 스킬 피해를 입힙니다. 해당 기본 공격이 적중한 위치엔 <color=#white>유리 파편</color>이 생성됩니다.","<color=green>지속 효과</color>: 타지아는 일정 시간마다 <color=#white>유리 칼날</color>을 생성합니다. 타지아가 <color=#white>유리 파편</color>에 접근하면 파괴하며 <color=#white>유리 칼날</color>을 회복합니다. <color=#white>유리 칼날</color>은 최대 4개까지 보유할 수 있습니다.\n\n<color=#white>유리 칼날</color>을 전방으로 투척해 적중한 적에게 <color=#white>{0}</color>의 스킬 피해를 입히고 <color=#white>유리 파편</color>을 생성합니다.\n\n<color=#white>스파다</color>: <color=#white>유리 검</color>을 보유중이면 <color=#white>유리 검</color>을 투척해 적중한 적에게 <color=#white>{1}</color>의 스킬 피해를 입히고 밀어내며 <color=#white>유리 파편</color>을 생성합니다. <color=#white>유리 검</color>은 첫 충돌후 관통하여 {3}m 더 전진한 후 폭발하며 주변에 <color=#white>{2}</color>의 스킬 피해를 입히고 <color=#white>유리 파편</color>을 추가로 생성합니다.","지정한 위치에 {2}초 동안 지속되는 불안정한 유리 장벽을 생성합니다. 적이 충돌하면 유리 장벽은 깨지며 충돌한 적을 {0}초 동안 기절 시키고 <color=#white>{1}</color>의 스킬 피해를 입힙니다.\n유리 장벽은 깨진 후 양 끝에 <color=#white>유리 파편</color>을 생성합니다.","지정한 지점으로 빠르게 이동해 주변의 <color=#white>유리 파편</color>을 파괴하고, 파괴한 <color=#white>유리 파편</color> 개수만큼 <color=#white>유리 칼날</color>을 회복합니다. <color=#white>유리 파편</color>을 하나라도 파괴했다면 도착 위치에서 타지아는 {7}초 동안 지속되는 <color=#white>{1}</color>의 보호막을 얻고 적에게 칼을 휘둘러 <color=#white>{0}</color>의 스킬 피해를 입히며 {5}초 동안 이동 속도를 {6} 느려지게 합니다. 그 후 {2}초 동안 이 스킬을 다시 사용할 수 있습니다.\n<color=#white>유리 파편</color>을 두 개 이상 파괴했다면, 피해량과 보호막량은 추가로 파괴한 <color=#white>유리 파편</color> 하나마다 {3}%씩 증가해 최대 {4}%까지 증가합니다.","지정한 위치에 {9}초 동안 지속되는 대검을 생성해 반경 {0}m 내 모든 <color=#white>유리 파편</color>을 파괴하고 반경 내 적의 이동 속도를 {8} 느리게 합니다. 대검에 적중당한 적은 <color=#white>{1}</color>의 스킬 피해를 입고 {2}초 동안 이동 속도가 {3}% 감소합니다.  대검의 지속 시간이 만료되거나 생성된 지 1초가 지난 대검에 <color=#white>유리 칼날</color>이나 <color=#white>유리 검</color>이 충돌하면 파괴되며 반경 {0}m에 <color=#white>{5}</color>의 스킬 피해를 입힙니다. 피해량은 파괴한 <color=#white>유리 파편</color> 하나마다 {6}%씩 증가해 최대 {7}%까지 증가합니다.","Tazia"],
      ["이렘은 다른 지역에 진입하면 경계하며 시야가 증가합니다. 같은 지역에서 일정 시간 머물면 적응하며 시야 증가 대신 다른 능력이 강화됩니다.\n이렘일 때: 쿨다운 감소\n고양이일 때: 방어력 증가\n\n생선으로 만든 음식을 먹으면 음식 최대 회복량의 일정 비율만큼 체력을 즉시 회복합니다.","<color=#ffd775>이렘:</color>\n이렘이 바닥에 튕길 때마다 강해지는 공을 던져 범위 안의 적들에게 스킬 피해를 입힙니다.\n공은 적에게 피해를 입히면 더 이상 튕기지 않고, 물고기 표식을 생성합니다.\n\n<color=#ffd775>고양이:</color>\n스킬을 사용하면 다음 기본 공격으로 대상에게 돌진하여 추가 스킬 피해를 입힙니다. 고양이 방울 표식이 있는 대상을 공격하면 기절시킵니다.\n\n이후 빠르게 연속 공격을 하여 범위 안의 적들에게 각각 스킬 피해를 입힙니다.\n연속 공격을 받는 대상이 방해효과를 받고 있다면 추가 피해를 입힙니다.","<color=#ffd775>이렘:</color>\n이렘이 매력을 발산하여 범위 안의 적들의 이동 속도를 느려지게 하고, 잠시 뒤에 범위 안의 대상들에게 스킬 피해를 입히며, 매혹에 빠지게 합니다.\n이동 속도 감소 효과는 범위 바깥으로 나가도 잠시 동안 유지됩니다.\n\n<color=#ffd775>고양이:</color>\n이렘이 공중에서 회전하며 강하게 꼬리로 내리쳐 범위 안의 적들에게 스킬 피해를 입히고 공중에 띄웁니다.\n이 스킬이 적에게 적중하면 <color=white>사뿐~</color>과 <color=white>폴짝!</color>의 쿨다운이 감소합니다.","<color=#ffd775>이렘:</color>\n이렘이 지정한 방향으로 짧게 이동하며, 원래 있던 자리에 물고기 표식을 생성합니다.\n\n<color=#ffd775>고양이:</color>\n이렘이 도약하여 착지할 때 범위 안의 적들에게 스킬 피해를 입힙니다.\n물고기 표식을 향해 도약하면 더 먼 거리를 이동할 수 있습니다.","<color=#ffd775>이렘:</color>\n이렘이 고양이로 변신합니다.\n이렘이 <color=white>바운싱 볼</color>이나<color=white> 사뿐~</color>으로 물고기 표식을 생성하면 다음 기본 공격은 사거리가 증가하며 추가 스킬 피해를 입히고, 잠시 동안 지속되는 고양이 방울 표식을 남깁니다.\n고양이 방울 표식의 대상은 이렘에게 시야를 공유합니다.\n\n<color=#ffd775>고양이:</color>\n고양이가 이렘으로 변신합니다.\n고양이로 변신한 이렘이 물고기 표식으로 이동하면 피해를 흡수하는 보호막을 획득합니다.","Irem"],
